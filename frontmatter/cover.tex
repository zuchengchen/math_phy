...
\begin{titlepage}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        ...
        \fill[covernavy] (current page.south west) rectangle ([xshift=4.25cm]current page.north west);
        \fill[covergold] ([xshift=4.25cm, yshift=-1.28cm]current page.north west)
            rectangle ([yshift=-1.06cm]current page.north east);

        % 左侧竖向辅助线
        \draw[white!18, line width=0.5pt]
            ([xshift=3.02cm, yshift=1.4cm]current page.south west) --
            ([xshift=3.02cm, yshift=-1.4cm]current page.north west);
        \draw[white!18, line width=0.5pt]
            ([xshift=3.46cm, yshift=1.4cm]current page.south west) --
            ([xshift=3.46cm, yshift=-1.4cm]current page.north west);
        ...
        \node[
            ...
            rotate=90,
            text=white!58,
            font=\fontsize{9.2pt}{11.2pt}\selectfont

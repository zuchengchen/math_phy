...
\begin{titlepage}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        ...
        % 波形装饰
        \begin{scope}[shift={([yshift=5.5cm]current page.south)}, opacity=0.45]
        ...
        % 高斯积分（左下）
        \node[anchor=south west, opacity=0.35, text=primaryblue] 
            at ([xshift=1cm, yshift=4.5cm]current page.south west)
    ...
    \begin{center}
        % 主标题
        {\fontsize{48pt}{56pt}\selectfont\bfseries\color{primaryblue} 数学物理方法\par}
        
        \vspace{0.3cm}
        
        % 英文副标题
        {\fontsize{13pt}{16pt}\selectfont\color{accentgold}\scshape Mathematical Methods for Physics\par}
        ...
        % 版本号
        {\fontsize{10pt}{12pt}\selectfont\color{accentgold!80!black} \textbf{Version 0.1}\par}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=center, white, font=\fontsize{13pt}{16pt}\selectfont\bfseries] 
            at ([yshift=2.8cm]current page.south) {物理与电子科学学院};
        \node[anchor=center, white!80, font=\fontsize{10pt}{12pt}\selectfont] 
            at ([yshift=2.1cm]current page.south) {School of Physics and Electronics};
        \node[anchor=center, accentgold, font=\fontsize{11pt}{13pt}\selectfont] 
            at ([yshift=1.3cm]current page.south) {\today};
    \end{tikzpicture}

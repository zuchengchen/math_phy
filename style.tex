...
\usepackage{graphicx}
\usepackage{tikz}
\usetikzlibrary{arrows.meta, calc, positioning, decorations.markings, decorations.pathmorphing, patterns}
\usepackage{pgfplots}
...
\newtcolorbox{jie}{
  ...
  before upper={\textcolor{examplepurple}{\textbf{解：}}\par\vspace{2pt}},
  after upper={\par\vspace{2pt}\hfill\textcolor{examplepurple!60}{$\square$}},
  breakable,
  before skip=0.3em,
  after skip=0.5em
}

...
\begin{tikzpicture}[
    ...
    % 后置课程（右侧）
    \node[related] (tmech) at (4.75, 2.5) {理论力学};
    \node[related] (edyn) at (4.75, 1.5) {电动力学};
    \node[related] (qm) at (4.75, 0.5) {量子力学};
    \node[related] (stat) at (4.75, -0.85) {热力学与统计物理};
    \node[group, text=green!50!black] at (4.75, 3.3) {相关课程};

...
\begin{itemize}
    \item 能从典型物理问题出发建立数学模型，并求解若干经典偏微分方程在常见初始条件和边界条件下的初边值问题
    \item 能较熟练地处理常见的边界条件和初始条件，并理解它们的物理意义
    \item 能理解复变函数在二维势场与复积分计算中的基本作用，并运用留数法计算一类实积分
    \item 能在球对称和圆柱对称问题中运用特殊函数求解具体问题
    \item 能把本课程中学到的方法迁移到后续理论物理课程的学习中
    \item 面对新的物理问题时，能初步判断应优先考虑哪些数学工具
\end{itemize}
